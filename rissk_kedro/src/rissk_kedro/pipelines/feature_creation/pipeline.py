...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    return pipeline([
        node(
            ...
            # Legacy test data: inputs=["legacy_microdata", "legacy_paradata_active", "parameters"],
        ...
        node(
            ...
            # Legacy test data: inputs=["legacy_paradata_active", "parameters"],
        ...
        node(
            ...
            # Legacy test data: inputs=["item_features_base", "legacy_paradata_active", "legacy_paradata_processed", "parameters"],
        ...
        node(
            ...
            # Legacy test data: inputs=["unit_features_base", "item_features", "legacy_paradata_processed", "parameters"],
